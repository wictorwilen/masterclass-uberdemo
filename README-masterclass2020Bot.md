# masterclass2020 - `masterclass2020Bot`
...
3. Give the bot a handle (ex: `masterclass2020Bot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://masterclassteams.ngrok.io/api/messages`
