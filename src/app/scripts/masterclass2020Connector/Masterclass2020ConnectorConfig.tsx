...
export interface IMasterclass2020ConnectorConfigState extends ITeamsBaseComponentState {
...
export interface IMasterclass2020ConnectorConfigProps {
}
...
/**
 * Implementation of the masterclass2020Connector Connector connect page
 */
export class Masterclass2020ConnectorConfig extends TeamsBaseComponent<IMasterclass2020ConnectorConfigProps, IMasterclass2020ConnectorConfigState> {
        ...
        if (await this.inTeams()) {
            ...
            microsoftTeams.settings.registerOnSaveHandler((saveEvent: microsoftTeams.settings.SaveEvent) => {
                ...
                const settings: any = {
                    ...
                    contentUrl: `https://${process.env.HOSTNAME}/masterclass2020Connector/config.html?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}`,
