...
export interface IMasterclass2020TabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IMasterclass2020TabRemoveProps {

}

/**
 * Implementation of Masterclass 2020 remove page
 */
export class Masterclass2020TabRemove  extends TeamsBaseComponent<IMasterclass2020TabRemoveProps, IMasterclass2020TabRemoveState> {
